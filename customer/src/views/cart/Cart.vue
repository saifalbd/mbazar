    ...
    <SfSidebar
                        ...
                        <SfCollectedProduct
                            ...
                            <template #actions>
                                <div class="desktop-only collected-product__actions">
                                    <SfButton class="sf-button--text color-secondary collected-product__save">
                                        Save for later
                                    </SfButton>
                                    <SfButton class="sf-button--text color-secondary collected-product__compare">
                                        Add to compare
                                    </SfButton>
                                </div>
                            </template>
        ...
        <template #content-bottom>
            <transition name="sf-fade">
                ...
                <div v-else>
                    <SfButton class="sf-button--full-width color-primary">Start shopping</SfButton>
                </div>
            </transition>
        </template>
    </SfSidebar>
