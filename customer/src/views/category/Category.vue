      ...
      <div class="products">
        ...
        >
          <SfProductCard
            ...
            :max-rating="5"
            :score-rating="product.ratingScore"
            :is-on-wishlist="product.isOnWishlist"
            :show-add-to-cart-button="!product.cart"
...
import { axiosWithoutToken,axios } from '../../plugins/axios';
...
export default {
      ...
      products: [
        {
          ...
          description:
           ...
           img: "http://localhost:8081/assets/storybook/Home/productA.jpg",
        ...
        },
        {
          ...
          description:
            "Find stunning women cocktail and party dresses. Stand out in lace and metallic cocktail dresses and party dresses from all your favorite brands.",
           img: "http://localhost:8081/assets/storybook/Home/productB.jpg",
          price: { regular: "$50.00" },
          ratingScore:4,
          reviewsCount: 8,
          isOnWishlist: false,
        },
        {
          ...
          description:
            "Find stunning women cocktail and party dresses. Stand out in lace and metallic cocktail dresses and party dresses from all your favorite brands.",
           img: "http://localhost:8081/assets/storybook/Home/productC.jpg",
          price: { regular: "$50.00" },
          ratingScore:4,
          reviewsCount: 8,
          isOnWishlist: false,
  ...
  methods: {
   ...
   let {data} =  await axios.post('./carts',d )
   ...
   let {data} = await axiosWithoutToken(`categories/${this.$route.params.slug}`);
  
   Product.insert({data:data.data})
   this.overlay = false;
