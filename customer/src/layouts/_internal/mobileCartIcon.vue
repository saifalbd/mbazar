<template>
<div class="e-mobile-cart-bar " :class="hasSubMenu?'e-hide-in-lg':false">
    <div>
        <div class="e-icon-box">
            <svg class="e-icon" viewBox="0 0 24 24">
...
created(){
this.hasSubMenu = this.$root.res.header.client_sub_menus.length;
}
}
</script>
