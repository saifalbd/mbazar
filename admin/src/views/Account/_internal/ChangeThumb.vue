        ...
        <vo ref="editProfile" v-slot="{ handleSubmit }">
            <v-form @submit.prevent="handleSubmit(editProfile)">
                <v-row>
                    ...
                    <v-col cols="12">
                        <vp v-slot="{ errors }" vid="image" name="Thumb" rules="required|image">
                            <v-file-input v-model="file" :error-messages="errors" color="deep-purple accent-4" counter label="Thumb input" placeholder="Select your files" prepend-icon="mdi-paperclip" outlined :show-size="1000">
